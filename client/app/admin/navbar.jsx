                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-sm-auto mx-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <Link className={"nav-link " + (currentPath === '/admin/dashboard' && 'active')} aria-current="page" href="/admin/dashboard"><BsFillGrid3X3GapFill className='fs-5 mb-1' /> Dashboard</Link>
                        </li>
                        <li className="nav-item">
                            <Link className={"nav-link " + (currentPath === '/admin/categories' && 'active')} href="/admin/categories"><BsListUl className='fs-5 mb-1' /> Categories</Link>
                        </li>
                        <li className="nav-item">
